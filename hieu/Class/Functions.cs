...
namespace QuanLyBanHang.Class
{
    class Functions
    {
        ...
        public static void Connect()
        {
            ...
            Con.ConnectionString = @"Data Source=LAPTOP-6JQ3QVFM\SQLEXPRESS;Initial Catalog=quanlybanhang;Integrated Security=True";
            Con.Open();                  //Mở kết nối
            //Kiểm tra kết nối
        ...
        internal static string ChuyenSoSangChuoi(string v)
        {
