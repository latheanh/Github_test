...
namespace QuanLyBanHang
{
    public partial class frmHoaDonBan : Form
    {
        ...
        // nap du lieu datagrid view
        private void LoadDataGridView()
        {
            string sql;
            sql = "SELECT a.MaHang, b.TenHang, a.SoLuong, b.DonGiaBan, a.GiamGia,a.ThanhTien FROM tblChiTietHDBan AS a, tblHang AS b WHERE a.MaHDBan = N'"
                + txtMaHDBan.Text + "' AND a.MaHang=b.MaHang";
            tblChiTietHDBan = Functions.GetDataToTable(sql);
            dgvHoaDonBanHang.DataSource = tblChiTietHDBan;
        ...
        // hien thi thong tin cua 1 hoa don duoc goi tu form tim kiem 
        private void LoadInfoHoaDon()
        {
            ...
            cboMaKhachHang.SelectedValue = Functions.GetFieldValues(str);
        ...
        private void btnInHoaDon_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["A1:B1"].Value = "DH10C8 Shop";
            exRange.Range["A2:B2"].MergeCells = true;
            exRange.Range["A2:B2"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A2:B2"].Value = "Phú Diễn - Hà Nội";
            exRange.Range["A3:B3"].MergeCells = true;
            exRange.Range["A3:B3"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A3:B3"].Value = "Điện thoại: (999)38526419";
